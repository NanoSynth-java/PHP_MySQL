...
$workexp = [
  [
    'workName' => 'Лётчик Испытатель',
    'dateStart' => '2010',
    'dateEnd' => 'current',
    'workDesc' => '.... .... ....'
  ],
  [
    'workName' => 'Частный Пилот',
    'dateStart' => '2001',
    'dateEnd' => '2010',
    'workDesc' => '.... .... ....'
  ],
  [
    'workName' => 'Военный лётчик-инструктор',
    'dateStart' => '1991',
    'dateEnd' => '2001',
    'workDesc' => 'TOP SECRET'
  ]
          ...
          <div class="w3-container">
            ...
            <?php for ($i=0; $i < count($skills); $i++):?>
              ...
              <div class="w3-light-grey w3-round-xlarge w3-small">
                <div class="w3-container w3-center w3-round-xlarge w3-teal" style="width:<?= $skills[$i]['percent']?>%">
                  <?= $skills[$i]['percent']?>%
                </div>
              </div>
            <?php endfor;?>
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          <h2 class="w3-text-grey w3-padding-16"><i
            ...
            <h5 class="w3-opacity"><b><?= $workexp[$i]['workName']?></b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?= $workexp[$i]['dateStart']?> - <span
                class="w3-tag w3-teal w3-round"><?= $workexp[$i]['dateEnd']?></span></h6>
            <p><?= $workexp[$i]['workDesc']?></p>
            <hr>
            <?php endfor;?>
          </div>
        </div>
